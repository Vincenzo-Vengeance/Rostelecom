...
class TestValidRegistrationRT:
    ...
    def open(self):
        self.driver = webdriver.Chrome('/Users/olhabockova/webdriver/chromedriver_107')
...
# python -m pytest -v --driver Chrome --driver-path /Users/olgabockova/bin/chromedriver107 test_rt_authorization.py *--alluredir reports*
